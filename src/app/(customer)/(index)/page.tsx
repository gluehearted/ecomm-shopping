            ...
            <div className="flex flex-col gap-[30px]">
                <div className="flex items-center gap-[10px] p-[8px_16px] rounded-full bg-white w-fit">
                    <div className="w-[22px] h-[22px] flex shrink-0">
                        <Image src="/icons/crown.svg" alt="icon" width={20} height={20}/>
                    </div>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <a href="" className="p-[18px_24px] rounded-full font-semibold bg-white">View Details</a>
                </div>
            </div>
            <div className="w-[588px] h-[360px] flex shrink-0 overflow-hidden relative">
                <Image src="/banners/mba13-m2-digitalmat-gallery-1-202402-Photoroom 2.png" className="object-contain" alt="icon" width={588} height={360}/>
                <div className="absolute top-[60%] bg-white p-[14px_16px] rounded-3xl flex items-center gap-[10px]">
                    <div className="w-12 h-12 flex shrink-0 rounded-full items-center justify-center bg-[#FFC736] overflow-hidden">
                        <Image src="/icons/code-circle.svg" className="w-6 h-6" alt="icon" width={20} height={20}/>
                    </div>
                ...
                <div className="absolute right-0 top-[30%] bg-white p-[14px_16px] rounded-3xl flex flex-col items-center gap-[10px]">
                    <div className="w-12 h-12 flex shrink-0 rounded-full items-center justify-center bg-[#FFC736] overflow-hidden">
                        <Image src="/icons/star-outline.svg" className="w-6 h-6" alt="icon" width={20} height={20}/>
                    </div>
        ...
        <div className="container max-w-[1130px] mx-auto flex items-center justify-center gap-10 mt-[50px]">
            <div className="flex items-center gap-[10px]">
                <div className="w-[50px] h-[50px] flex shrink-0 rounded-full border-[5px] border-white overflow-hidden">
                    <Image src="/photos/p1.png" className="w-full h-full object-cover" alt="photo" width={50} height={50}/>
                </div>
            ...
            <div className="flex items-center gap-[10px]">
                <div className="w-[50px] h-[50px] flex shrink-0 rounded-full border-[5px] border-white overflow-hidden">
                    <Image src="/photos/p2.png" className="w-full h-full object-cover" alt="photo" width={50} height={50}/>
                </div>
                <div className="flex flex-col gap-[2px]">
            ...
            <div className="flex items-center gap-[10px]">
                <div className="w-[50px] h-[50px] flex shrink-0 rounded-full border-[5px] border-white overflow-hidden">
                    <Image src="/photos/p3.png" className="w-full h-full object-cover" alt="photo" width={50} height={50}/>
                </div>
                <div className="flex flex-col gap-[2px]">
            ...
            <div className="flex items-center gap-[10px]">
                <div className="w-[50px] h-[50px] flex shrink-0 rounded-full border-[5px] border-white overflow-hidden">
                    <Image src="/photos/p4.png" className="w-full h-full object-cover" alt="photo" width={50} height={50}/>
                </div>
                <div className="flex flex-col gap-[2px]">
