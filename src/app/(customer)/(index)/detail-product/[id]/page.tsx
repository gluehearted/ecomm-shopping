    ...
    <div id="details-benefits" className="container max-w-[1130px] mx-auto flex items-center gap-[50px] justify-center mt-[50px]">
        <div className="flex items-center gap-[10px]">
            <div className="w-12 h-12 flex shrink-0 rounded-full bg-[#FFC736] items-center justify-center overflow-hidden">
                <Image src="/icons/star-outline.svg" alt="icon" width={48} height={48} />
            </div>
        ...
        <div className="flex items-center gap-[10px]">
            <div className="w-12 h-12 flex shrink-0 rounded-full bg-[#FFC736] items-center justify-center overflow-hidden">
                <Image src="/icons/code-circle.svg" alt="icon" width={48} height={48} />
            </div>
        ...
        <div className="flex items-center gap-[10px]">
            <div className="w-12 h-12 flex shrink-0 rounded-full bg-[#FFC736] items-center justify-center overflow-hidden">
                <Image src="/icons/like.svg" alt="icon" width={48} height={48} />
            </div>
        ...
        <div className="flex items-center gap-[10px]">
            <div className="w-12 h-12 flex shrink-0 rounded-full bg-[#FFC736] items-center justify-center overflow-hidden">
                <Image src="/icons/tag.svg" alt="icon" width={48} height={48} />
            </div>
            ...
            <div id="testi" className="flex flex-col gap-[10px]">
                ...
                <div className="grid grid-cols-2 gap-5">
                    <div className="testi-card flex flex-col bg-white p-5 gap-5 border border-[#E5E5E5] rounded-[20px] h-fit">
                        ...
                        <div className="flex items-center gap-[10px]">
                            <div className="w-[50px] h-[50px] flex shrink-0 rounded-full p-1 border border-[#E5E5E5] overflow-hidden">
                                <Image src="/photos/p2.png" className="w-full h-full object-cover rounded-full" alt="photo" width={50} height={50} />
                            </div>
                    ...
                    <div className="testi-card flex flex-col bg-white p-5 gap-5 border border-[#E5E5E5] rounded-[20px] h-fit">
                        ...
                        <div className="flex items-center gap-[10px]">
                            <div className="w-[50px] h-[50px] flex shrink-0 rounded-full p-1 border border-[#E5E5E5] overflow-hidden">
                                <Image src="/photos/p4.png" className="w-full h-full object-cover rounded-full" alt="photo" width={50} height={50} />
                            </div>
                            <div className="flex flex-col gap-[2px]">
                    ...
                    <div className="testi-card flex flex-col bg-white p-5 gap-5 border border-[#E5E5E5] rounded-[20px] h-fit">
                        ...
                        <div className="flex items-center gap-[10px]">
                            <div className="w-[50px] h-[50px] flex shrink-0 rounded-full p-1 border border-[#E5E5E5] overflow-hidden">
                                <Image src="/photos/p3.png" className="w-full h-full object-cover rounded-full" alt="photo" width={50} height={50} />
                            </div>
                            <div className="flex flex-col gap-[2px]">
                    ...
                    <div className="testi-card flex flex-col bg-white p-5 gap-5 border border-[#E5E5E5] rounded-[20px] h-fit">
                        ...
                        <div className="flex items-center gap-[10px]">
                            <div className="w-[50px] h-[50px] flex shrink-0 rounded-full p-1 border border-[#E5E5E5] overflow-hidden">
                                <Image src="/photos/p1.png" className="w-full h-full object-cover rounded-full" alt="photo" width={50} height={50} />
                            </div>
                            <div className="flex flex-col gap-[2px]">
